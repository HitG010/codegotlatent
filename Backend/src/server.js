...
app.post('/auth/signup', async (req, res) => {
    ...
    try {
        ...
        const accessToken = await generateAccessToken({ id: newUser.id, email: newUser.email });
        const refreshToken = await generateRefreshToken({ id: newUser.id, email: newUser.email });
