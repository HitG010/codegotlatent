  ...
  return (
    <div className='flex flex-col items-center gap-4 justify-center h-screen bg-cover bg-center bg-[#1A1A1A]' style={{ backgroundImage: `url(${cgl_bg2})`, backgroundSize: 'cover' }}>
        <img src={latentNavLogo} alt='Code Got Latent' className='absolute top-4' />
          ...
          <h2 className='text-4xl font-medium text-[#f1f3f5]'>Log In</h2>
          ...
          <button type="submit" className="bg-[#f1f3f5] py-3 w-full text-[#1a1a1a] font-semibold flex gap-2 justify-center items-center rounded-lg hover:bg-[#e0e0e0] hover:gap-3 transition-all duration-300 cursor-pointer" onClick={handleLogin}>Let's Go! <FaArrowRight className='w-3 h-3'/></button>
          </div>
    </div>
  )
}
